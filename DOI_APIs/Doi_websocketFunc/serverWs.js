...
const {multiplayerRouteBoard} = require("./multiplayerRoutes");
            ...
            try{
                ...
                switch(true)
                {
                    case parsed.type === 'multiplayer':
                        multiplayerRouteBoard({reqData:parsed,ws:ws , gameConnectionDB:createGame_connection , userConnectionDB:UsersAccount_connection,
                        tournamentConnection
                        });
                    break;
                    case parsed.type === 'tournament':
