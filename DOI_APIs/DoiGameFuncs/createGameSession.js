...
const createNewGameSession = async({userID , tournamentInfo = {} , duration = {"minute": 5,"seconds": 0} , playersCount , gameType , guessDigitCount , createGame_connection , initID , gameMode}) =>{
    ...
    const newSession = new createSession({hostID:userID,gameID,tournamentInfo,duration , joinCode , jwtGameAuth:inviteToken , playersCount , gameType , guessDigitCount , gameMode}).getObject();
