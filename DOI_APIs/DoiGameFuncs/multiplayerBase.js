...
async function getCallsNupdate_MODE1(msg , connectionWs , gameConnectionDB){
...
async function endGameSeq_MODE({gameID , gameConnectionDB , winnerPosition , connectionWs , initiatorLose = false}){
    try{
        await gameConnectionDB.findOneAndUpdate(
            { gameID },
            {$set : {
